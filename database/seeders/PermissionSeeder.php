...
class PermissionSeeder extends Seeder
{
    ...
    public static function definitions(): array
    {
        return [
            ...
            ['key' => 'identity.configure', 'module' => 'identity-verification', 'description' => 'Configure identity verification requirements for events and ticket tiers.', 'scope' => 'tenant', 'risk_level' => 'sensitive'],
            ['key' => 'identity.review', 'module' => 'identity-verification', 'description' => 'Review face-capture and manual identity verification submissions.', 'scope' => 'tenant', 'risk_level' => 'sensitive'],
            ['key' => 'identity.data.view', 'module' => 'identity-verification', 'description' => 'View minimized sensitive identity verification metadata.', 'scope' => 'tenant', 'risk_level' => 'privileged'],
            ['key' => 'identity.data.manage', 'module' => 'identity-verification', 'description' => 'Delete sensitive identity verification data and run exceptional compliance actions.', 'scope' => 'tenant', 'risk_level' => 'privileged'],
            ...
            // ── Access Control (ACS) ─────────────────────────
            ['key' => 'acs.configure', 'module' => 'access-control', 'description' => 'Configure ACS zones, lanes, rules, and integration credentials.', 'scope' => 'tenant', 'risk_level' => 'sensitive'],
            ['key' => 'acs.events.view', 'module' => 'access-control', 'description' => 'View gate access events.', 'scope' => 'tenant', 'risk_level' => 'standard'],
            ['key' => 'acs.health.view', 'module' => 'access-control', 'description' => 'View ACS integration and lane health.', 'scope' => 'tenant', 'risk_level' => 'standard'],
            ...
            // ── Venue Marketplace ────────────────────────────
            ['key' => 'venue.manage', 'module' => 'venue-marketplace', 'description' => 'Manage venue profiles, assets, availability, pricing, and publication.', 'scope' => 'tenant', 'risk_level' => 'sensitive'],
            ['key' => 'marketplace.manage', 'module' => 'venue-marketplace', 'description' => 'Browse marketplace catalog, request quotes, and submit rental requests.', 'scope' => 'tenant', 'risk_level' => 'sensitive'],
            ['key' => 'rentals.approve', 'module' => 'venue-marketplace', 'description' => 'Approve, reject, and revoke marketplace rental requests.', 'scope' => 'tenant', 'risk_level' => 'sensitive'],
            ...
            ['key' => 'platform.marketplace.disputes.manage', 'module' => 'venue-marketplace', 'description' => 'Review and resolve marketplace statement disputes.', 'scope' => 'platform', 'risk_level' => 'privileged'],
        ];
    }
