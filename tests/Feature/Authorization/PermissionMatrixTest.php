...
class PermissionMatrixTest extends TestCase
{
    ...
    public function test_every_seeded_permission_has_explicit_allow_and_deny_evidence(): void
    {
        ...
        $assignmentId = DB::table('tenant_role_assignments')->insertGetId(['tenant_id' => $fixture['tenant']->id, 'tenant_membership_id' => $fixture['membership']->id, 'tenant_role_id' => $tenantRole->id, 'granted_by_user_id' => $fixture['user']->id, 'created_at' => now(), 'updated_at' => now()]);
        ...
        DB::table('platform_role_assignments')->insert(['user_id' => $fixture['user']->id, 'platform_role_id' => $platformRole->id, 'granted_by_user_id' => $fixture['user']->id, 'created_at' => now(), 'updated_at' => now()]);
