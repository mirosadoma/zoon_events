...
final class FakeEmailAdapter implements NotificationAdapter
{
    ...
    public function send(NotificationRequest $request): NotificationResult
    {
        ...
        return $this->next ?? new NotificationResult(NotificationStatus::Accepted, 'fake-email-'.$request->notificationId);
    }
}
